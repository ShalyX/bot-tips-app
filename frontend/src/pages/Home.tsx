        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              <Link to="/dashboard" className="bg-surface-container border border-primary-fixed/40 text-primary-fixed font-button-text px-8 py-4 rounded-lg flex items-center gap-2 hover:bg-primary-fixed hover:text-on-primary-fixed transition-all">
